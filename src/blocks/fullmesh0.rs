...
//         FullMeshBlock { block : block_data , weights:  &[],  outputs: & mut [] ,inputs: &[]  , neural_behaviour:  ::std::marker::PhantomData   }
//     }
//
...
// {
//     fn as_blocktype (&self) -> Box<BlockType> {  Box::new  ( BlockType::SBlock (&self) ) }
//
// }
//
//
