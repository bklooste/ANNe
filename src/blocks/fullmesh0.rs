...
impl<'a,W ,O ,N>  MutableBlock <'a, O ,W> for FullMeshBlock<'a,W ,O ,N>
...
impl< '_, W  ,O ,N>  NeuronBlock<W, O>  for FullMeshBlock< '_,W ,O ,N>
where W: Num + Debug +'_  , O: Num + Debug +'_, N: Neuron <W,O>
{
